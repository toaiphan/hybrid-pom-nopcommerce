...
public class UserCheckOutPageUI {
	...
	public static final String PAYMENT_METHOD_TEXT = "//span[contains(text(),'Payment Method:')]//following-sibling::span";
	public static final String SHIPPING_METHOD_TEXT = "//span[contains(text(),'Shipping Method:')]//following-sibling::span";
	...
	public static final String BILLING_CONTINUE_BUTTON = "//div[@id='billing-buttons-container']//button[@type='button'][contains(text(),'Continue')]";
	public static final String SHIPPING_ADDRESS_DROPDOWN = "//select[@id='shipping-address-select']";
	public static final String ADDRESS_CONTINUE_BUTTON = "//div[@id='shipping-buttons-container']//button[@type='button'][contains(text(),'Continue')]";
	public static final String CONFIRM_CONTINUE_BUTTON = "//div[@id='payment-info-buttons-container']//button[@type='button'][contains(text(),'Continue')]";

	public static final String BILLING_EMAIL_TEXT = "//div[@class='billing-info']//ul[@class='info-list']//li[@class='email']";
	public static final String SHIPPING_PHONE_TEXT = "//div[@class='shipping-info']//ul[@class='info-list']//li[@class='phone']";
public static final String SUCCESS_MESSAGE ="//strong[contains(text(),'Your order has been successfully processed!')]";
